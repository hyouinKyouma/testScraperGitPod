import scrapy
class WilsongardenSpider(scrapy.Spider):
    name = 'wilson-garden'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/wilson-garden-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'wilson-garden.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/wilson-garden-restaurants"
