...
class BattarahalliSpider(scrapy.Spider):
    name = 'battarahalli'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/battarahalli-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'battarahalli.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/battarahalli-restaurants"
