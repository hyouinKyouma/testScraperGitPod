import scrapy
class RtnagarSpider(scrapy.Spider):
    name = 'rt-nagar'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/rt-nagar-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'rt-nagar_batch2.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/rt-nagar-restaurants"
