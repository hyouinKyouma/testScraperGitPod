...
class IndiranagarSpider(scrapy.Spider):
    name = 'indiranagar'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/indiranagar-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'indiranagar.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/indiranagar-restaurants"
