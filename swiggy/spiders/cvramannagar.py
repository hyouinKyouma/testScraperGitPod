import scrapy
class CvramannagarSpider(scrapy.Spider):
    name = 'cv-raman-nagar'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/cv-raman-nagar-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'cv-raman-nagar.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/cv-raman-nagar-restaurants"
