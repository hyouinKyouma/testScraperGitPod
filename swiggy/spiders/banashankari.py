...
class banashankariSpider(scrapy.Spider):
    name = 'banashankari'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/banashankari-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'banashankari.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/banashankari-restaurants"
