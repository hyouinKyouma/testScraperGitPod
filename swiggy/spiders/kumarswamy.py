...
class KumaraswamylayoutSpider(scrapy.Spider):
    name = 'kumaraswamylayout'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/kumaraswamy-layout-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'kumaraswamylayout.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/kumaraswamy-layout-restaurants"
