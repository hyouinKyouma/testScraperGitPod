import scrapy
class SanjaynagarSpider(scrapy.Spider):
    name = 'sanjaynagar'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/sanjay-nagar-new-bel-road-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'sanjaynagar.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/sanjay-nagar-new-bel-road-restaurants"
