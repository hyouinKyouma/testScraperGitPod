import scrapy
class MarathahalliSpider(scrapy.Spider):
    name = 'marathahalli'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/marathahalli-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'marathahalli.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/marathahalli-restaurants"
