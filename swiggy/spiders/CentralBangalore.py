import scrapy
class CentralbangaloreSpider(scrapy.Spider):
    ...
    start_urls = ["https://www.swiggy.com/bangalore/central-bangalore-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'central-bangalore.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/central-bangalore-restaurants"
