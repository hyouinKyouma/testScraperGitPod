import scrapy
class WhitefieldSpider(scrapy.Spider):
    name = 'whitefield'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/whitefield-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'whitefield.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/whitefield-restaurants"
