...
class KammanahalliSpider(scrapy.Spider):
    name = 'kammanahalli'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/kammanahalli-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'kammanahalli.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/kammanahalli-restaurants"
