import scrapy
class SarjapurSpider(scrapy.Spider):
    name = 'sarjapur'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/bellandur%20sarjapur-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'sarjapur.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/bellandur%20sarjapur-restaurants"
