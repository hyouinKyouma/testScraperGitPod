import scrapy
class JpnagarSpider(scrapy.Spider):
    name = 'jp-nagar'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/jp-nagar-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'jp-nagar.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/jp-nagar-restaurants"
