...
class KoramangalaSpider(scrapy.Spider):
    name = 'koramangala'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/koramangala-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'kormangala.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/koramangala-restaurants"
