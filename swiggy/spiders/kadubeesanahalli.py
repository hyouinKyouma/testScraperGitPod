import scrapy
class KadubeesanahalliSpider(scrapy.Spider):
    ...
    start_urls = ["https://www.swiggy.com/bangalore/kadubeesanahalli-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'kadubeesanahalli.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/kadubeesanahalli-restaurants"
