import scrapy
class BasaveshwaranagarSpider(scrapy.Spider):
    ...
    start_urls = ["https://www.swiggy.com/bangalore/basaveshwaranagar-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'basaveshwaranagar.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/basaveshwaranagar-restaurants"
