...
class BasavanagudiSpider(scrapy.Spider):
    name = 'basavanagudi'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/basavanagudi-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'basavanagudi.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/basavanagudi-restaurants"
