import scrapy
class KanakapuraSpider(scrapy.Spider):
    name = 'Kanakapura'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/Kanakapura_Road-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'Kanakapura.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/Kanakapura_Road-restaurants"
