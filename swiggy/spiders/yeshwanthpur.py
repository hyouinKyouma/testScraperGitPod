import scrapy
class YeshwanthpurSpider(scrapy.Spider):
    name = 'yeshwanthpur'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/yeshwanthpur-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        # 'FEED_URI': 's3://zara2dectest/swiggy_data_aws_docker.csv'
        'FEED_URI': 's3://test12jan/swiggy_data_aws_docker.csv'
        # 'FEED_URI': 'swiggy_data_aws_docker_local.csv's3/buckets/test12jan
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/yeshwanthpur-restaurants"
