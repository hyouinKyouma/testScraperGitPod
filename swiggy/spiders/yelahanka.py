import scrapy
class YelahankaSpider(scrapy.Spider):
    name = 'yelahanka'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/yelahanka-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'yelahanka.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/yelahanka-restaurants"
