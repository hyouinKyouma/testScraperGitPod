import scrapy
class KadugodiSpider(scrapy.Spider):
    name = 'kadugodi'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/kadugodi-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'kadugodi.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/kadugodi-restaurants"
