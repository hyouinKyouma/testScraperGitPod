import scrapy
class RajajinagarSpider(scrapy.Spider):
    name = 'rajajinagar'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/rajajinagar-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'rajajinagar.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/rajajinagar-restaurants"
