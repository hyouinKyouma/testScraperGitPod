import scrapy
class BanaswadiSpider(scrapy.Spider):
    name = 'banaswadi'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/banaswadi-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'banaswadi.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/banaswadi-restaurants"
