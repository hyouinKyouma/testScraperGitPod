import scrapy
class ShantinagarSpider(scrapy.Spider):
    name = 'shantinagar'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/shantinagar-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'shantinagar.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/shantinagar-restaurants"
