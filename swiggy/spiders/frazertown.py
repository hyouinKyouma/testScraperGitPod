import scrapy
class FrazertownSpider(scrapy.Spider):
    name = 'frazertown'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/frazer-town-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'frazertown.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/frazer-town-restaurants"
