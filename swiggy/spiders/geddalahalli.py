import scrapy
class GeddalahalliSpider(scrapy.Spider):
    name = 'geddalahalli'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/geddalahalli-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'geddalahalli.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/geddalahalli-restaurants"
