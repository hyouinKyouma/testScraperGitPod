...
class MahadevpuraSpider(scrapy.Spider):
    name = 'mahadevpura'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/mahadevpura-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'mahadevpura.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/mahadevpura-restaurants"
