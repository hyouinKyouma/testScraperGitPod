import scrapy
class ElectroniccitySpider(scrapy.Spider):
    ...
    start_urls = ["https://www.swiggy.com/bangalore/electronic-city-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'electronic-city.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/electronic-city-restaurantss"
