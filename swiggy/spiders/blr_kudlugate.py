import scrapy
class BlrkudlugateSpider(scrapy.Spider):
    name = 'blr_kudlugate'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/blr_kudlugate-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'blr_kudlugate.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/blr_kudlugate-restaurants"
