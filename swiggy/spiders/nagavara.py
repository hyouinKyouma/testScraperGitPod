...
class NagavaraSpider(scrapy.Spider):
    name = 'nagavara'
    ...
    start_urls = ["https://www.swiggy.com/bangalore/nagavara-hennur-restaurants"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'nagavara.csv'
    }
    def __init__(self):
        self.domain = "https://www.swiggy.com/bangalore/nagavara-hennur-restaurants"
